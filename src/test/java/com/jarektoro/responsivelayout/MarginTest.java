...
public class MarginTest extends AbstractTest {
    ...
    protected void init(VaadinRequest request) {
        ...
        ResponsiveRow firstRow = responsiveLayout.addRow().withMargin(ResponsiveRow.MarginSize.NORMAL, true).withComponents(new Button("Button"), new Button("Button"), new Button("Button"));
        firstRow.setCaption("Row with normal margin & fluid Components");
        firstRow.addStyleName("blue");

        ResponsiveRow secondRow = responsiveLayout.addRow().withMargin(ResponsiveRow.MarginSize.SMALL, true).withComponents(new Button("Button"), new Button("Button"), new Button("Button"));
        secondRow.setCaption("Row with small margin & fluid Components");
        secondRow.addStyleName("blue");

        ResponsiveRow thirdRow = responsiveLayout.addRow().withMargin(ResponsiveRow.MarginSize.NORMAL, true);
        ...
        ResponsiveRow fourthRow = responsiveLayout.addRow().withMargin(ResponsiveRow.MarginSize.SMALL, true);
